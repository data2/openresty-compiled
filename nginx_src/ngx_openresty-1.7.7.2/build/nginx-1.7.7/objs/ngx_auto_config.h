#define NGX_CONFIGURE " --prefix=/app/chinaudp/soft/openresty/nginx --with-cc-opt='-I/app/chinaudp/soft/luajit/include/luajit-2.1 -O2' --add-module=../ngx_devel_kit-0.2.19 --add-module=../echo-nginx-module-0.57 --add-module=../xss-nginx-module-0.04 --add-module=../ngx_coolkit-0.2rc2 --add-module=../set-misc-nginx-module-0.28 --add-module=../form-input-nginx-module-0.10 --add-module=../encrypted-session-nginx-module-0.03 --add-module=../srcache-nginx-module-0.28 --add-module=../ngx_lua-0.9.14 --add-module=../ngx_lua_upstream-0.02 --add-module=../headers-more-nginx-module-0.25 --add-module=../array-var-nginx-module-0.03 --add-module=../memc-nginx-module-0.15 --add-module=../redis2-nginx-module-0.11 --add-module=../redis-nginx-module-0.3.7 --add-module=../rds-json-nginx-module-0.13 --add-module=../rds-csv-nginx-module-0.05 --with-ld-opt='-Wl,-rpath,/app/chinaudp/soft/luajit/lib -L/app/chinaudp/soft/luajit/lib' --add-module=/app/chinaudp/soft/nginx_src/naxsi-core-0.49/naxsi_src --add-module=/app/chinaudp/soft/nginx_src/nginx-http-concat-1.2.2 --add-module=/app/chinaudp/soft/nginx_src/nginx_upstream_check_module-master --with-http_realip_module --with-http_addition_module --with-http_gzip_static_module --with-http_random_index_module --with-http_stub_status_module --with-http_sub_module --with-http_dav_module --with-http_ssl_module --with-pcre=/app/chinaudp/soft/nginx_src/pcre-8.10"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.1.2 20080704 (Red Hat 4.1.2-46)"
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/app/chinaudp/soft/openresty/nginx/"
#endif
