#define NGX_CONFIGURE " --prefix=../nginx_dir/nginx --with-cc-opt=-O2 --add-module=../ngx_devel_kit-0.3.1rc1 --add-module=../echo-nginx-module-0.61 --add-module=../xss-nginx-module-0.06 --add-module=../ngx_coolkit-0.2 --add-module=../set-misc-nginx-module-0.32 --add-module=../form-input-nginx-module-0.12 --add-module=../encrypted-session-nginx-module-0.08 --add-module=../srcache-nginx-module-0.31 --add-module=../ngx_lua-0.10.15 --add-module=../ngx_lua_upstream-0.07 --add-module=../headers-more-nginx-module-0.33 --add-module=../array-var-nginx-module-0.05 --add-module=../memc-nginx-module-0.19 --add-module=../redis2-nginx-module-0.15 --add-module=../redis-nginx-module-0.3.7 --add-module=../rds-json-nginx-module-0.15 --add-module=../rds-csv-nginx-module-0.09 --add-module=../ngx_stream_lua-0.0.7 --with-ld-opt='-Wl,-rpath,../nginx_dir/luajit/lib -Wl,-rpath,../nginx_src/luajit/lib' --with-openssl=/home/openresty/openresty-1.15.8.2/../openssl-1.0.2t --with-pcre=/home/openresty/openresty-1.15.8.2/../pcre-8.43 --with-stream --with-stream_ssl_module --with-stream_ssl_preread_module --with-http_ssl_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.4.7 20120313 (Red Hat 4.4.7-18) (GCC) "
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "../nginx_dir/nginx/"
#endif
